# Only install deps when run outside this project (e.g., `elixir examples/jinja_demo.exs`)
...
defmodule JinjaDemo do
  ...
  def run do
    ...
    model = System.get_env("LLAMA_SWAP_MODEL", "qwen3-coder.gguf")
    ...
    prompt = [
      ...
      Message.new_user!("Write a 3-line Elixir function that reverses a string.")
    ]
